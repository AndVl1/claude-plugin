...
skills: kotlin-spring-patterns, ktgbotapi-patterns, koog, ktor-client, react-vite, telegram-mini-apps, kmp, compose, compose-arch, decompose, iterative-refinement, state-machine-workflow
---
