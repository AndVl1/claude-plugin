...
skills: kotlin-spring-patterns, kotlin-spring-boot, ktgbotapi, ktgbotapi-patterns, jooq-patterns, ktor-client, workflow-orchestrator, systematic-planning, openrouter-integration, code-quality-checklist
---
