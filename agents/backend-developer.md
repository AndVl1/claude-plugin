...
skills: kotlin-spring-patterns, kotlin-spring-boot, ktgbotapi, ktgbotapi-patterns, jooq-patterns, ktor-client, iterative-refinement, tool-orchestration, state-machine-workflow
---
